...
class RouteType(str, Enum):
    ...
    REACT = "react"                # ReAct loop - гибкий исследовательский подход
    PLAN_EXECUTE = "plan_execute"  # Plan-and-Execute - структурированный подход

    # Для обратной совместимости (deprecated)
    AGENT = "plan_execute"         # Алиас для PLAN_EXECUTE
...
class RouteDecision(BaseModel):
    ...
    Определяет какую стратегию использовать: SIMPLE, REACT или PLAN_EXECUTE.
    """
    ...
    strategy_reasoning: Optional[str] = Field(default=None, description="Детальное обоснование выбора стратегии")
